...
public class MemberController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<SignUpResponseDTO> signUpMember(@RequestBody @Validated SignUpRequestDTO signUpDTO){
        log.info("request signup member");
        return ResponseEntity.ok().body(memberService.signUpMember(signUpDTO));
    }
}
